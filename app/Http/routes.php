...
Route::get('user/sign_in', function() { return view('layouts.auth'); });
Route::get('user/sign_up', function() { return view('layouts.auth'); });
Route::get('user/sign_up_success', function() { return view('layouts.auth'); });
Route::get('user/confirm/{confirmation_code}', function() { return view('layouts.auth'); });
Route::get('user/forgot_password', function() { return view('layouts.auth'); });
